...
def run_sprinklers(app):
    ...
    with app.app_context():
        ...
        scheduledZones = ZoneSchedule.query.join(Valve, ZoneSchedule.zone == Valve.valve).add_columns(Valve.valve, Valve.description, Valve.gpio_pin, ZoneSchedule.runLength)
